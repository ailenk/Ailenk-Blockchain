...
module.exports = function(callback) {
    ...
    EcommerceStore.deployed().then(function(i) {i.addProductToStore('天梭男111', '手表', 'QmReMAp8UXR5r4Rgi35Ade9uK2D3v3M1LEcHMjfBYXYZ91', 'QmbWwss8TGmLbE3NZawbzRqPst15d7FEUSCDfN6stkgQg1', current_time, current_time + 60, 2*amt_1, 0).then(function(f) {console.log(f)})});
